...
<div class="hero">
    <div style="padding: 25px;">
        <table style="border: 0;">
            <tr style="border: 0;">
                <td style="border: 0; vertical-align: middle; text-align: center;">
                    <img src="/assets/images/logo_white.svg" width="150px" style="transform: rotate(-8deg); margin-top: auto; margin-bottom: auto;">
                </td>
            </tr>
        </table>
    </div>
