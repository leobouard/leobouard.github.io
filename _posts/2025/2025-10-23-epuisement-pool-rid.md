...
>
> J'ai testé et il n'y a qu'un seul pool RID qui est révoqué à la fois, même si la commande a été faite plusieurs fois. Le seul moyen d'invalider plusieurs pools RID est d'alterner entre l'invalidation du pool RID et la création d'un objet Active Directory (pour débloquer le nouveau pool RID).
