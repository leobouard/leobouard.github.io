...
- **Plus de contrôle sur l'authentification** : vous pouvez contrôler la durée de vie du ticket Kerberos, l'usage du NTLM au sein d'un silo sans avoir à ajouter tous les utilisateurs dans le groupe *Protected Users*.
...
- Le groupe *Allowed to authenticate to T1* qui va autoriser ses membres à se connecter aux serveurs du TIER 1
- L'utilisateur *t1_lbouard* qui représente un administrateur TIER 1
- Le serveur *SRV01* qui représente un serveur du TIER 1
- L'utilisateur *t2_lbouard* qui représente un administrateur TIER 2
- Le serveur *SRV02* qui représente un serveur du TIER 2
...
Plus d'informations sur le sujet ici : [Authentification composée et revendications Active Directory Domain Services dans Services ADFS \| Microsoft Learn](https://learn.microsoft.com/fr-fr/windows-server/identity/ad-fs/operations/ad-fs-compound-authentication-and-ad-ds-claims) (Étape 1 & 2 uniquement).
